...
static struct mv88fx_i2s_info mv88fx_i2s_info[2];
...
static void mv88fx_i2s_dai_remove(struct snd_soc_dai *dai)
{
	mv88fx_snd_debug("");
...
struct snd_soc_dai_driver mv88fx_i2s_dai0 = {
	.name = "mv88fx-i2s0",
//	.id = 0,
...
struct snd_soc_dai_driver mv88fx_i2s_dai1 = {
	.name = "mv88fx-i2s1",
//	.id = 0,
	.probe = mv88fx_i2s_dai_probe,
	.remove = mv88fx_i2s_dai_remove,
...
extern struct snd_soc_dai_driver tda19988_dai;
