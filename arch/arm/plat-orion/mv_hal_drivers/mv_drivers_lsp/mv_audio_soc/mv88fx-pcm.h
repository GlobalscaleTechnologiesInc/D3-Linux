...
extern struct mv88fx_snd_chip *mv88fx_pcm_snd_chip[2];

#define mv88fx_pcm_get_chip(substream) mv88fx_pcm_snd_chip[(to_platform_device(substream->pcm->card->dev))->id]
#define mv88fx_pcm_is_stereo(runtime)        ((runtime)->channels != 1)


extern struct snd_soc_platform_driver mv88fx_soc_platform;
