...
void __init orion_ehci_init(unsigned long mapbase,
			    unsigned long irq,
			    enum orion_ehci_phy_ver phy_version, void *pdata, char *dev_name )
{
	if ( dev_name )  orion_ehci.name = dev_name;
	if ( pdata )  orion_ehci.dev.platform_data = pdata;
...
void __init orion_ehci_1_init(unsigned long mapbase,
			      unsigned long irq, void *pdata, char *dev_name )
{
	if ( dev_name )  orion_ehci_1.name = dev_name;
	if ( pdata )  orion_ehci.dev.platform_data = pdata;
