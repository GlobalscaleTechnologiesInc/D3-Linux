...
static unsigned long bmm_size_mb = 96;
...
static int bmm_ioctl(struct file * filp, 
		   unsigned int cmd, unsigned long arg)
{
	...
	pr_debug(" ***bmm_ioctl1:: (cmd=0x%08x, arg=0x%08lx, io=0x%08lx/0x%08lx)\n",
	...
	pr_debug(" ***bmm_ioctl2:: (cmd=0x%08x, arg=0x%08lx, io=0x%08lx/0x%08lx)\n",
		cmd, arg, io.input, io.output);
